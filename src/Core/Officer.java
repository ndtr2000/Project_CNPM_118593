...
public class Officer extends Person {
	...
	public Officer(String idPerson, String idFamily, String lastName, String firstName, String relationship, Date birth, String gender, String address, String email,
	...
	public String toString() {
		return "Officer [startDateTerm=" + startDateTerm + ", endDateTerm=" + endDateTerm + ", lastName=" + lastName
				+ ", firstName=" + firstName + "]";
	}
